...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <link rel="stylesheet" href="{{asset('/pubadmin/css/morris.css')}}" type="text/css"/>
    <!-- calendar -->
    <link rel="stylesheet" href="{{asset('/pubadmin/css/monthly.css')}}">
    <!-- //calendar -->
    <!-- //font-awesome icons -->
    <script src="{{asset('/pubadmin/js/jquery2.0.3.min.js')}}"></script>
    <script src="{{asset('/pubadmin/js/raphael-min.js')}}"></script>
    <script src="{{asset('/pubadmin/js/morris.js')}}"></script>
</head>
<body>
            ...
            <ul class="nav pull-right top-menu">
                ...
                <li class="dropdown">
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                        <img alt="" src="{{asset('/pubadmin/images/hungdo.jpg')}}">
                        <span class="username">
                                    <?php
                    ...
                    <ul class="dropdown-menu extended logout">
                        ...
                        <li><a href="{{url('/getadmin-logout')}}"><i class="fa fa-key"></i> Log Out</a></li>
                    </ul>
                </li>
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <li class="sub-menu">
                        <a href="javascript:;">
                            ...
                            <span>Thương hiệu san pham</span>
                        </a>
                        <ul class="sub">
                            <li><a href="{{url('/add-brand-product')}}">Thêm thương hiệu sản phẩm</a></li>
                            <li><a href="{{url('/all-brand-product')}}">Liệt thương hiệu mục sản phẩm</a></li>
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            ...
                            <li><a href="{{url('/all-product')}}">Liệt sản phẩm</a></li>
...
<!-- calendar -->
<script type="text/javascript" src="{{asset('/pubadmin/js/monthly.js')}}"></script>
