...
<div class="log-w3">
    <div class="w3layouts-main">
        ...
        <form action="{{url('/save-admin-register')}}" method="post">
            @csrf
            ...
            <input type="text" class="ggg" name="admin_address" placeholder="Nhập đia chi" required="">

            <span><input type="checkbox" />Nhớ đăng nhập</span>
            <h6><a href="{{url('/admin-login')}}">you have aready sigin</a></h6>
