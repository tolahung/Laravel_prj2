            ...
            <div class="table-responsive">
                <table class="table table-striped b-t b-light">
                    ...
                    <tr>
                        ...
                        <td><span class="text-ellipsis">
                              <?php
                                    if($key->category_status==0){
                                        ?>
                                        <a href="{{url('/unactive-category-product/'.$key->category_id.'/click')}}">Ẩn</a>
                                <?php
                                   }else{
                                    ?>
                                            <a href="{{url('/active-category-product/'.$key->category_id.'/click')}}">Hiển thị</a>
                                <?php
                                    }
                                    ?>
                            </span></td>
                        ...
                        <td>
                            <a href="{{url('/edit-category-product/'.$key->category_id.'/click')}}" class="active" ui-toggle-class=""><i class="fa fa-pencil-square-o text-success text-active"></i></a>
