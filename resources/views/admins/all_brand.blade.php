                            ...
                            <td><span class="text-ellipsis">
                              <?php
                                    if($key->brand_status==0){
                                        ?>
                                        <a href="{{url('/unactive-brand-product/'.$key->brand_id.'/click')}}">Ẩn</a>
                                <?php
                                    }else{
                                        ?>
                                            <a href="{{url('/active-brand-product/'.$key->brand_id.'/click')}}">Hiển thị</a>
                                <?php
                                    }
                                        ?>
                            </span></td>
